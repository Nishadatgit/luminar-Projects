...
class CustomShagger extends StatefulWidget {
  const CustomShagger({Key? key}) : super(key: key);

  @override
  State<CustomShagger> createState() => _CustomShaggerState();
}

class _CustomShaggerState extends State<CustomShagger> {
      ...
      body: Container(
        ...
        child: StaggeredGridView.countBuilder(
            ...
            staggeredTileBuilder: (index) {
              return StaggeredTile.count(1, index % 5 == 3 ? 1.3 : 1.8);
            }),
      ),
    );
  }
